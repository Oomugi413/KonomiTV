...
WORKDIR /
## リリース版用
# RUN aria2c -x10 https://github.com/Oomugi413/KonomiTV/releases/download/v0.12.1/thirdparty-linux.tar.xz
# RUN tar xvf thirdparty-linux.tar.xz
## 開発版 (0.x.x-dev) 用
RUN aria2c -x10 https://nightly.link/Oomugi413/KonomiTV/actions/runs/15985716093/thirdparty-linux.tar.xz.zip
